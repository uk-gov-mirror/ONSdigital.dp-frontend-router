...
func redirectsRedirectsCsv() (*asset, error) {
	...
	info := bindataFileInfo{name: "redirects/redirects.csv", size: 17870, mode: os.FileMode(420), modTime: time.Unix(1516367539, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
